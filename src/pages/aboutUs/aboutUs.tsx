...
Although she has a two-year gap in her IT career, she is currently focused on upskilling and returning to front-end development. She is actively refreshing her technical knowledge and learning modern technologies to re-enter the industry with confidence."
      ...
      <h2>Contribution to the project:</h2>
        ...
        <p className='contribution-point'>Designed and implemented routing and navigation across the application/</p>
        <p  className='contribution-point'>Built core pages including Home, Product, About Us, and a global Loading screen</p>
        <p  className='contribution-point'>Integrated and configured a commercetools project as the primary backend</p>
        <p  className='contribution-point'>Developed product listing features with sorting, filtering, and search using the commercetools API</p>
        <p  className='contribution-point'>Organized project workflows by setting up a Jira board, creating tasks, and assigning responsibilities to team members</p>

         <h3>Ruslana Tretiakova</h3>
        <p  className='contribution-point'>Implemented the entire user registration flow, including form validation, authentication integration, automatic login, and address selection</p>
        <p  className='contribution-point'>Built a full-featured user profile page with editable personal information, email, password, and address management</p>
        <p  className='contribution-point'>Developed interactive shopping cart functionality with add/remove logic using the API</p>
        <p  className='contribution-point'>Contributed to initial project setup, including TypeScript configuration, Vitest testing, Husky Git hooks, and a modular folder structure</p>

        <h3>Olga Nikanorova</h3>
        <p  className='contribution-point'>Implemented token management and user authentication</p>
        <p  className='contribution-point'>Fully developed the product detail card with dynamic data and interaction</p>
        <p  className='contribution-point'>Created the shopping cart page with item rendering, bulk removal, and promo code functionality</p>
        <p  className='contribution-point'>Customized Commercetools setup to meet project-specific requirements</p>
    </div>
  );
}
